  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex flex-col gap-8 mt-[74px] mb-[216px]">
        <Link to="" className="relative font-bold flex items-center justify-center h-[66px] w-[213px] shadow-[2px_2px_5px_0px_rgba(197,143,53,0.68)] rounded-[10px]">
        المستندات 
        ...
        <img src={bedar} className='absolute -z-50 w-[246px] h-[246px] -bottom-6 object-cover' />
      </div>
    </div>
  );
}
