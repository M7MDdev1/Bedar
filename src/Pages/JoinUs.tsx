  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex flex-col items-center w-full bg-[#C58F3526] pb-32">
        <Link
          to="/TeamLogin"
          className="w-48 h-36 flex flex-col items-center justify-center bg-white m-11 pt-4 rounded-2xl border-2 border-dashed border-[#C58F35]"
        >
        ...
        <Link
          to="/SingleLogin"
          className="w-48 h-36 flex flex-col items-center justify-center bg-white m-11 pt-4 rounded-2xl border-2 border-[#C58F35]"
        >
        ...
        <img
          src={bedar}
          className="absolute -z-50 w-60 top-[45%] left-[50%] -translate-x-1/2 -translate-y-1/2"
        />
      </div>
    </div>
  );
