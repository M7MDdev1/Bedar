  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex flex-col items-center w-full bg-[#C58F3526] pb-32">
        <Link to="/TeamLogin" className="w-48 h-36 flex flex-col items-center justify-center bg-white m-11 pt-4 rounded-2xl border-2 border-dashed border-[#C58F35]">
          <img src={team} className='w-17'/>
          <p className='text-xl'>فريق</p>
        </Link>
        <Link to="/SingleLogin" className="w-48 h-36 flex flex-col items-center justify-center bg-white m-11 pt-4 rounded-2xl border-2 border-[#C58F35]">
