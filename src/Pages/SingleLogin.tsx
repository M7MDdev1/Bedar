            ...
            <Form className="w-full flex flex-col gap-4 p-4">
                  ...
                  {field.type === "select" ? (
                    <>
                      <Field
                        ...
                        name={field.name}
                        dir="rtl"
                        className="relative h-[46px] text-right rounded-2xl border border-amber-500/70 text-gray-400 p-3 pr-[26px] appearance-none cursor-pointer focus:outline-none"
                      >
                    ...
                    <>
                      <Field
                        ...
                        className="h-[46px] text-right rounded-2xl border border-amber-500/70 p-3 pr-[26px] cursor-pointer"
                      ></Field>
                      <ErrorMessage
                        name={field.id}
                        component="div"
              ...
              <div className="relative text-right mb-8 px-4">
                <h3 className="text-center text-[#C58F35] font-bold my-8">
                  انضم لكوكبة من المتميزين في عالم التطوع
                </h3>
                <div className="flex items-center justify-end mb-[14px]">
                  <ErrorMessage
                    ...
                    className="text-red-400 text-sm"
                  />
                  <label htmlFor="eq" className="text-black font-bold mx-3">
                    إقرار
                  </label>
                  <Field
                    type="checkbox"
